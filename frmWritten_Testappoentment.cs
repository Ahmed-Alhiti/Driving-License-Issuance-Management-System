...
{
    public partial class frmWritten_Testappoentment : Form
    {
        ...
        public frmWritten_Testappoentment(int id)
        {
            InitializeComponent();
            License_id = id;
        }
        ...
        {
            Last_appointment = clsTestAppointments.GetLastTestAppointment(License_id, clsTestTypes.enTestType.WrittenTest);
            ...
            if (clsTests.CheckTestResult(2, License_id))
            {
            ...
            if (dgvAppointments.Rows.Count == 0)
            {
                ...
                sechduleTest.testType = frmSechduleTest.enTestType.written;
            ...
            else
            {
                ...
                //if (tests != null && tests._TestResult == false)
                if (!clsTests.CheckTestResult(2, License_id))
                {
                    frmSechduleTest sechduleTest = new frmSechduleTest(License_id, -1);
                    sechduleTest.testType = frmSechduleTest.enTestType.written;
                ...
                sechduleTest1.testType = frmSechduleTest.enTestType.written;
        ...
        {
            dgvAppointments.DataSource = Last_appointment.GetAll(2);
        }
        private void _LoadData()
        {
            ...
            dlInfo1.lblAppApplicant.Text = license.ApplicantFullName;
        ...
        private void frmWritten_Testappoentment_Load(object sender, EventArgs e)
        {
            _GetAllTest();
            _LoadData();
        ...
        private void TakeTestStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            takeTest.testType = frmTakeTest.enTestType.written;
            takeTest.ShowDialog();
            _GetAllTest();
